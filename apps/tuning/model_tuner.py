...
class ModelTuner:
    ...
    def best_params_randomforest(self, train_x, train_y):
        ...
        try:
            ...
            self.grid = GridSearchCV(
                estimator=self.rfc, param_grid=self.param_grid, cv=5
            )
            ...
            self.logger.exception(
                "Exception raised while finding best params for randomforest algo:"
                + str(e)
            )
            raise Exception()
    ...
    def best_params_xgboost(self, train_x, train_y):
        ...
        try:
            ...
            self.logger.exception(
                "Exception raised while finding best params for XGBoost algo:" + str(e)
            )
            raise Exception()
    ...
    def get_best_model(self, train_x, train_y, test_x, test_y):
        ...
        try:
            ...
            if (
                ...
                self.logger.info(
                    "Accuracy for XGBoost:" + str(self.random_forest_score)
                )
            else:
